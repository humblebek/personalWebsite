            ...
            <div class="row g-4">
                <div class="col-sm-12 col-xl-6 "  >
                    ...
                    <div class="bg-light rounded h-100 p-4">
                        <h6 class="mb-4 fs-2"> Add a quote</h6>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text"  name="quote_uz">
                        </div>
                        <div class="mb-3">
                            <label for="formFileMultiple" class="form-label">Quote EN</label>
                            <input class="form-control" type="text"  name="quote_en">
                        </div>
                        <div class="mb-3">
                            <label for="formFileMultiple" class="form-label">Quote RU</label>
                            <input class="form-control" type="text"  name="quote_ru">
                        </div>
